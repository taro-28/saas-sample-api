...
func (ec *executionContext) field_Mutation_createTodo_args(ctx context.Context, rawArgs map[string]interface{}) (map[string]interface{}, error) {
	...
	if tmp, ok := rawArgs["input"]; ok {
		...
		arg0, err = ec.unmarshalNCreateTodoInput2githubᚗcomᚋtaroᚑ28ᚋsaasᚑsampleᚑapiᚋgraphᚋmodelᚐCreateTodoInput(ctx, tmp)
		if err != nil {
			return nil, err
		}
	}
...
func (ec *executionContext) unmarshalNCreateTodoInput2githubᚗcomᚋtaroᚑ28ᚋsaasᚑsampleᚑapiᚋgraphᚋmodelᚐCreateTodoInput(ctx context.Context, v interface{}) (model.CreateTodoInput, error) {
